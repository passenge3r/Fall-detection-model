# EZOpenSDK-android-对讲-本地音频音量大小回调.md

> EZOpenSDK-android-对讲-本地音频音量大小回调

> 更新时间: 2026-06-02T14:03:41.000+08:00

> 文档ID: 4180 | 来源树: SDK及示例
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEZPlayer.setVoiceTalkLoudnessCallback(v -> {
            ...
            if (mTalkLocalLoudnessTv != null) {
                runOnUiThread(() -> mTalkLocalLoudnessTv.setText(String.format("本地音频音量：%.2f分贝 ", v)));
            }
        }, 0.15f);
