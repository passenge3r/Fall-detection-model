# API-设备云组件仓-智能电梯网络摄像机-电梯物联组件-查询电梯列表

> 更新时间: 2026-06-30T11:54:25.000+08:00

> 文档ID: 1611 | 来源树: OPEN_API
...
   电梯业务服务组件，分页查询当前用户的电梯信息列表

- 请求地址

`https://open.ys7.com/api/service/devicekit/elevator/info/list`
...
| query | size | Int | 每一页响应多少条记录，size最大不超50，超过50按50处理 | Y |
| query | startTime | String | 与电梯信息创建时间对比，时间格式参照：2023-04-18 12:00:00 | Y |
| query | endTime | String | 与电梯信息创建时间对比，时间格式参照：2023-04-18 12:00:00 | Y |

- 请求示例

```
curl --location --request GET 'https://open.ys7.com/api/service/devicekit/elevator/info/list?size=10&startTime=2023-04-18 12:00:00&endTime=2023-07-18 12:00:00' \
    ...
    "data": [
        {
            ...
            "useEnterprise": "",
            "useStauts": "using",
            "createTime": "2023-07-10 20:44:37",
            "modifyTime": "2023-07-10 20:44:37",
