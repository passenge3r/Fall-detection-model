# API-设备云组件仓-智能电梯网络摄像机-电梯物联组件-获取电梯sos事件

> 更新时间: 2026-06-30T11:55:32.000+08:00

> 文档ID: 1629 | 来源树: OPEN_API
...
   电梯困人告警事件查询，电梯困人告警会触发求救事件，该API提供困人告警事件查询功能，可获取事件发生时间，楼层，困人数等

- 请求地址

`https://open.ys7.com/api/devicekit/elevator/sos/info/detail`
...
| query | eventId | String | 事件id | Y |

- 请求示例

```
curl --location --request GET 'https://open.ys7.com/api/devicekit/elevator/sos/info/detail?elevatorSerial=EL123456&startTime=2024-01-01 00:00:00&endTime=2024-01-01 23:59:59&size=10&eventId=evt001' \
...
| data.recordDetailVos.doorCloseTime | Int | 关门时间 |
