...
> 更新时间: 2026-06-23T17:34:09.000+08:00

> 文档ID: 2819 | 来源树: OPEN_API
...
   取反开关操作。如果窗帘当前开合状态为全关状态，会变为全开状态；如果窗帘当前开合状态为非全关状态，会变为全关状态。支持托管及子账号，设备级，校验权限为Config。
...
| Header | actionIdentifier | String | 功能点标识，填写报备时的操作标识符，固定值：Toggle | Y |
...
--header 'actionIdentifier: Toggle'
```
