# API-设备云组件仓-智能锁-基础功能-门锁操作-删除用户指纹密码

> 更新时间: 2026-07-09T13:44:55.000+08:00

> 文档ID: 758 | 来源树: OPEN_API
...
`https://open.ys7.com/api/lapp/keylock/user/delete/finger`
...
```
curl --location --request DELETE 'https://open.ys7.com/api/lapp/keylock/user/delete/finger' \
