...
> 更新时间: 2026-07-09T13:45:24.000+08:00

> 文档ID: 819 | 来源树: OPEN_API
...
该接口用于设置人脸解锁计划。本文档仅适用于设备型号：CS-DL30-V100系列和CS-Y3000F-V100系列智能门锁，其余型号不保证可用。如下接口调用需要联系萤石配置白名单，否则接口可能调用报错。
...
```
curl --location --request PUT 'https://open.ys7.com/api/v3/otap/prop/{deviceSerial}/DoorLock/0/DoorLockCtrl/FaceUnlockPlan' \
