# API-设备云组件-安全帽-获取设备本地按键权限

> API-设备云组件-安全帽-获取设备本地按键权限

> 更新时间: 2026-05-25T16:38:50.000+08:00

> 文档ID: 1483 | 来源树: OPEN_API
...
获取设备本地按键权限，获取关机按键权限使能、录像按键权限使能。
...
1.	{
2.	 "shutdown":  true, 
3.	 /*ro, opt, bool, 关机按键权限使能, desc:远程关闭设备本地电源按键的控制权限。*/
4.	 "recordButtonEnabled":  true 
5.	 /*ro, opt, bool, 录像按键权限使能, desc:远程关闭设备本地录像按键的控制权限。*/6.	}
```
