# API-设备云组件-安全帽-配置指定通道编码参数

> API-设备云组件-安全帽-配置指定通道编码参数

> 更新时间: 2026-05-25T16:38:51.000+08:00

> 文档ID: 1488 | 来源树: OPEN_API
...
获取指定通道编码参数。其中，针对安全帽相机（DS-MCH208），仅支持配置设备视频的视频编码类型、分辨率宽与高。并且该设备仅包含主码流。
...
- Resquest Body请求参数（json）

```
1.	<?xml version="1.0" encoding="UTF-8"?>
2.	<StreamingChannel xmlns="http://www.isapi.org/ver20/XMLSchema" version="2.0">
3.	  <!--req, object, 编码参数, attr:version{opt, string, 协议版本}-->
4.	  <id>
5.	    <!--req, string, 通道ID-->test
6.	  </id>
7.	  <Video>
8.	    <!--opt, object, 视频配置-->
9.	    <videoCodecType>
10.	      <!--req, enum, 视频编码类型, subType:string, [UNKNOWN#UNKNOWN,MPEG4#MPEG4,MJPEG#MJPEG,3GP#3GP,H.264#H.264,HK.264#HK.264,MPNG#MPNG,SVAC#SVAC,H.265#H.265,H.264BP#H.264BP,H.264HP#H.264HP,H.264SVC#H.264SVC,MPEG2#MPEG2]-->H.264
11.	    </videoCodecType>
12.	    <!—分辨率宽高可设置为以下三种：720*576（D1）、1280*720（720P）、1920*1080（1080P）-->
13.	    <videoResolutionWidth>
14.	      <!--req, int, 分辨率宽-->720
15.	    </videoResolutionWidth>
16.	    <videoResolutionHeight>
17.	      <!--req, int, 分辨率高-->576
18.	    </videoResolutionHeight>
19.	  </Video>
20.	</StreamingChannel>
```
