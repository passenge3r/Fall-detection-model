# API-设备云组件-安全帽-配置设备本地录像按键控制参数（远程开启/关闭本地录像）

> API-设备云组件-安全帽-配置设备本地录像按键控制参数（远程开启/关闭本地录像）

> 更新时间: 2026-05-25T16:38:52.000+08:00

> 文档ID: 1493 | 来源树: OPEN_API

---

## 配置设备本地录像按键控制参数（远程开启/关闭本地录像）

接口分类：ISAPI能力

- URL

https://open.ys7.com/api/hikvision/ISAPI/System/localButtonRecord?format=json

- 接口描述

配置设备本地录像按键控制参数。支持远程开启/关闭本地录像，并设置录像每个片段的时间长度。
...
1.	{
2.	 "enabled":  true, 
3.	 /*opt, bool, 远程控制设备本地录像按键使能。true为开启录像，false为关闭录像 */
4.	 "recordSegmentDuration":  5 
5.	 /*opt, enum, 录像保存时的分段时长, subType:int, [5#5分钟,10#10分钟,20#20分钟,30#30分钟], desc:本地录像按键开启录像时，按上述时长进行保存。对应事件localButtonRecord*/
6.	}
```
