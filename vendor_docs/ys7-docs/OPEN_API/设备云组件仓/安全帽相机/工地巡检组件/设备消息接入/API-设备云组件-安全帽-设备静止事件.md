# API-设备云组件-安全帽-设备静止事件

> API-设备云组件-安全帽-设备静止事件

> 更新时间: 2026-05-25T16:38:54.000+08:00

> 文档ID: 1499 | 来源树: OPEN_API
...
```
{
 ...
 "eventType":  "deviceNotMoved", 
 /*ro, req, enum, 事件类型, subType:string, [deviceNotMoved#设备静止报警]*/
 "eventState":  "active", 
 ...
 "eventDescription":  "Device Not Moved", 
 /*ro, req, string, 事件描述*/
 "channelName":  "ABC", 
