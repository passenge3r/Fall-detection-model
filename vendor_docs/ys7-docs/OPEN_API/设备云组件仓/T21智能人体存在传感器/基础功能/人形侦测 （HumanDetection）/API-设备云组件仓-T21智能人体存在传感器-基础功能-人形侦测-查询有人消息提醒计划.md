# API-设备云组件仓-T21智能人体存在传感器-基础功能-人形侦测-查询有人消息提醒计划

> 更新时间: 2026-07-06T13:47:17.000+08:00

> 文档ID: 1107 | 来源树: OPEN_API
...
   该接口用于查询有人消息提醒计划。本文档仅适用于设备型号 CS-T21-DG，其余型号不保证可用。
...
| data.plan[].action[].actionType | String | 执行动作，取值范围[1,2556] |
