# API-设备云组件仓-T21智能人体存在传感器-基础功能-人形侦测-设置有人进入检测自定义声音

> 更新时间: 2026-07-06T13:47:46.000+08:00

> 文档ID: 1116 | 来源树: OPEN_API
...
   该接口用于设置有人进入检测自定义声音。本文档仅适用于设备型号 CS-T21-DG，其余型号不保证可用。
...
```
curl --location --request PUT 'https://open.ys7.com/api/v3/otap/prop/{deviceSerial}/global/0/HumanDetection/InCustomSound' \
