...
> 更新时间: 2026-06-24T15:56:15.000+08:00

> 文档ID: 2074 | 来源树: OPEN_API
...
    设置睡眠监测时间段。功能点标识符：SleepDetectTimeRange。
...
| header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，示例值：SleepDetectTimeRange | Y |
| body | EndTime | String | 睡眠监测结束时间，范围：[1,] | N |
| body | StartTime | String | 睡眠监测开始时间，范围：[1,] | N |
...
--header 'propIdentifier: SleepDetectTimeRange' \
--data-raw '{
  "EndTime":"",
  "StartTime":""
}'
