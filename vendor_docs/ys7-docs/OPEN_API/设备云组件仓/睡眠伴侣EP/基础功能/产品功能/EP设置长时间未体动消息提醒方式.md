...
> 更新时间: 2026-06-24T15:56:11.000+08:00

> 文档ID: 2073 | 来源树: OPEN_API
...
    设置长时间未体动消息提醒方式。功能点标识符：MotionLessNoticeMode。
...
| header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，示例值：MotionLessNoticeMode | Y |
| body | data | Integer | 长时间未体动消息提醒方式，范围：[1,2,3]，1-关闭此类消息 2-接收消息但不推送 3-接收消息并推送 | Y |
...
--header 'propIdentifier: MotionLessNoticeMode' \
--data-raw '783355221'
```
