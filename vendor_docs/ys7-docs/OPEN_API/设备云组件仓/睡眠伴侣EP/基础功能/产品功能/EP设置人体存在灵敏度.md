...
> 更新时间: 2026-06-25T14:31:29.000+08:00

> 文档ID: 2056 | 来源树: OPEN_API
...
   设置人体存在灵敏度（BodyDetectSensitivity）。
...
| body | data | Integer | 人体存在灵敏度，范围：[1,2,3]；1-灵敏度低；2-灵敏度中；3-灵敏度高 | Y |

- 请求示例

```
curl --location --request PUT 'https://open.ys7.com/api/v3/device/otap/prop?deviceSerial=xxxxxxxxx&localIndex=0&resourceCategory=global&domainIdentifier=SleepDetector&propIdentifier=BodyDetectSensitivity' \
