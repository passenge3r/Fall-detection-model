...
> 更新时间: 2026-06-24T15:56:31.000+08:00

> 文档ID: 2080 | 来源树: OPEN_API
...
   设置长时间未体动检测使能（MotionLessDetectEnabled）
...
| header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，示例值：MotionLessDetectEnabled | Y |
...
--header 'propIdentifier: MotionLessDetectEnabled' \
--data-raw 'true'
```
