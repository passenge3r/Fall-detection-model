...
> 更新时间: 2026-06-24T15:56:26.000+08:00

> 文档ID: 2078 | 来源树: OPEN_API
...
    设置离床未归检测使能。功能点标识符：LeaveBedDetectEnabled。
...
| header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，示例值：LeaveBedDetectEnabled | Y |
...
--header 'propIdentifier: LeaveBedDetectEnabled' \
--data-raw 'true'
```
