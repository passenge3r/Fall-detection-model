...
> 更新时间: 2026-06-25T14:20:39.000+08:00

> 文档ID: 1935 | 来源树: OPEN_API
...
| Header | domainIdentifier | String | 功能点领域，填写报备时的属性所在领域，固定值Humiture | Y |
| Header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，固定值TemperatureUnit | Y |
| Header | Content-Type | String | application/json | Y |
| Body | unit | String | 测温单位，范围[celsius,fahrenheit]。celsius-摄氏度，fahrenheit-华氏度 | Y |
...
--header 'propIdentifier: TemperatureUnit' \
--header 'Content-Type: application/json' \
--data-raw '{"unit":"celsius"}'
```
