...
> 更新时间: 2026-06-25T14:21:08.000+08:00

> 文档ID: 1952 | 来源树: OPEN_API
...
   设置PM1.0告警阈值（通过OTAP协议设置设备的PM1.0告警阈值属性）
...
| Header | domainIdentifier | String | 功能点领域，填写报备时的属性所在领域，如PMSense | Y |
| Header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，如PM1\_0AlarmThreshold | Y |
| Body | maxPM1\_0 | Integer | 最大浓度，范围[0,100] | N |
| Body | minPM1\_0 | Integer | 最小浓度，范围[0,100] | N |
...
--header 'propIdentifier: PM1_0AlarmThreshold' \
--data-raw '{"maxPM1_0": 0, "minPM1_0": 0, "enabled": true}'
```
