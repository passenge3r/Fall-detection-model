...
> 更新时间: 2026-06-25T14:20:55.000+08:00

> 文档ID: 1948 | 来源树: OPEN_API
...
| Header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，固定值PM10AlarmThreshold | Y |
| Header | Content-Type | String | application/json | Y |
| Body | minPM10 | Integer | 最小浓度，范围[0,100] | N |
| Body | maxPM10 | Integer | 最大浓度，范围[0,100] | N |
...
--header 'propIdentifier: PM10AlarmThreshold' \
--header 'Content-Type: application/json' \
--data-raw '{"minPM10":0,"maxPM10":100,"enabled":true}'
```
