# API-设备云组件-宠物喂食器-喂食相关-出粮异常检测-【消息】没有粮食流出

> API-设备云组件-宠物喂食器-喂食相关-出粮异常检测-【消息】没有粮食流出

> 更新时间: 2026-05-25T16:39:45.000+08:00

> 文档ID: 1576 | 来源树: OPEN_API
...
- 消息体（需在出粮检测打开时，在出粮时会判断出粮状态，如在应该出粮时检测到设备未能真正出粮会产生消息上报。）
...
| basic. continue | 后续有相同UUID的报文(用于补充图片) | boolean |  | 默认为false，后续不会有相同UUID的报文。不带图片或则带图片的事件无实时性要求，该节点可以不要。 | N |
