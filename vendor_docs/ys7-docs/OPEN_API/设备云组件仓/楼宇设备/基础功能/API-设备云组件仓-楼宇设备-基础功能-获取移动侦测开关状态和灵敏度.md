# API-设备云组件仓-楼宇设备-基础功能-获取移动侦测开关状态和灵敏度

> 更新时间: 2026-07-01T18:44:51.000+08:00

> 文档ID: 1339 | 来源树: OPEN_API
...
   该接口用于获取楼宇可视对讲设备移动侦测开关状态和灵敏度。本节为楼宇可视对讲透传相关接口，该接口只支持楼宇相关设备。子账户token请求所需最小权限：无。

- 请求地址

`https://open.ys7.com/api/lapp/building/device/defence/config/get`
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/building/device/defence/config/get' \
...
| data.enable | Int | 0关，1开，移动侦测开关状态 |
| data.sensitivity | Int | 灵敏度，取值1-6 |
