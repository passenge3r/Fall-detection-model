# API-设备云组件仓-楼宇设备-基础功能-获取智能锁列表

> 更新时间: 2026-07-01T18:45:04.000+08:00

> 文档ID: 1344 | 来源树: OPEN_API
...
   该接口用于获取楼宇可视对讲设备智能锁列表。本节为楼宇可视对讲透传相关接口，该接口只支持楼宇相关设备。子账户token请求所需最小权限：无。

- 请求地址

`https://open.ys7.com/api/lapp/building/device/smartlock/list`
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/building/device/smartlock/list' \
