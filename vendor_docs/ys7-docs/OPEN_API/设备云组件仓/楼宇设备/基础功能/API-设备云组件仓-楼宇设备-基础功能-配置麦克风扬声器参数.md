# API-设备云组件仓-楼宇设备-基础功能-配置麦克风扬声器参数

> 更新时间: 2026-07-01T18:44:44.000+08:00

> 文档ID: 1335 | 来源树: OPEN_API
...
   该接口用于配置楼宇可视对讲设备麦克风扬声器参数。本节为楼宇可视对讲透传相关接口，该接口只支持楼宇相关设备。子账户token请求所需最小权限：无。

- 请求地址

`https://open.ys7.com/api/lapp/building/device/audio/config`
...
| Body | type | Int | 0-配置扬声器音量；1-配置麦克风音量 | Y |
| Body | value | Int | 0-10之间的数字，代表配置扬声器或麦克风的音量大小 | Y |

- 请求示例

```
curl --location --request POST 'https://open.ys7.com/api/lapp/building/device/audio/config' \
