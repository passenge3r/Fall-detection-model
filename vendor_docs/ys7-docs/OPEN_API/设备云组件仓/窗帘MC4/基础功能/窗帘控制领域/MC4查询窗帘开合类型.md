...
> 更新时间: 2026-06-25T14:25:29.000+08:00

> 文档ID: 2024 | 来源树: OPEN_API
...
   查询MC4窗帘电机当前的开合类型（单开/双开），通过otap透传通道读取属性值。
...
| data.type | String | 开合类型，名称：开合类型，范围：[single,double]，single-单开，double-双开 |
