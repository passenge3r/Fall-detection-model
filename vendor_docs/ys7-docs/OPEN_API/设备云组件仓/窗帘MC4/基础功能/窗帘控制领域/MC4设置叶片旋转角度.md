...
> 更新时间: 2026-06-25T14:25:27.000+08:00

> 文档ID: 2023 | 来源树: OPEN_API
...
   设置MC4窗帘电机的叶片旋转角度，通过otap透传通道下发属性设置。
...
| header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，示例：BladeRotationAngle | Y |
| body | angle | Integer | 角度，名称：角度，范围：[0,180] | Y |
...
--header 'propIdentifier: BladeRotationAngle' \
--data-raw '{
    "angle": 100
}'
```
