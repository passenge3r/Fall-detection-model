...
> 更新时间: 2026-06-25T14:25:20.000+08:00

> 文档ID: 2021 | 来源树: OPEN_API
...
| header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，示例：OpeningClosingSpeed | Y |
| body | speedLevel | Int | 速度等级，范围[1,10] | N |
...
--header 'propIdentifier: OpeningClosingSpeed' \
--data-raw '{"speedLevel":8}'
```
