...
> 更新时间: 2026-06-25T14:25:31.000+08:00

> 文档ID: 2025 | 来源树: OPEN_API
...
   设置MC4窗帘电机的开合类型（单开/双开），通过otap透传通道下发属性设置。
...
| header | propIdentifier | String | 功能点标识，填写报备时的属性标识符，示例：OpeningClosingType | Y |
| body | type | String | 开合类型，名称：开合类型，范围：[single,double]，single-单开，double-双开 | Y |
...
--header 'propIdentifier: OpeningClosingType' \
--data-raw '{
    "type": "double"
}'
```
