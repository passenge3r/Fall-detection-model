...
> 更新时间: 2026-06-25T14:25:33.000+08:00

> 文档ID: 2026 | 来源树: OPEN_API
...
   MC4窗帘电机按指定百分比开合窗帘，通过otap透传通道下发开合控制指令。
...
| header | actionIdentifier | String | 功能点标识，填写报备时的操作标识符，示例：OpenCloseCurtain | Y |
| body | percent | Integer | 指定开合百分比，名称：指定开合百分比，范围：[0,100] | Y |
...
--header 'actionIdentifier: OpenCloseCurtain' \
--data-raw '{
    "percent": 30
}'
```
