...
> 更新时间: 2026-07-06T13:50:52.000+08:00

> 文档ID: 1220 | 来源树: OPEN_API
...
```
curl --location --request GET 'https://open.ys7.com/api/v3/otap/prop/{deviceSerial}/Outlet/0/OutletControl/OutletSwitchTimePlan' \
