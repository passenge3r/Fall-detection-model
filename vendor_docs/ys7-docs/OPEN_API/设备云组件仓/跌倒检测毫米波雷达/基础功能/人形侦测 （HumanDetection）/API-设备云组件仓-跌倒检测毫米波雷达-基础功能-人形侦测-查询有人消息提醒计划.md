# API-设备云组件仓-跌倒检测毫米波雷达-基础功能-人形侦测-查询有人消息提醒计划

> 更新时间: 2026-07-01T18:25:11.000+08:00

> 文档ID: 1275 | 来源树: OPEN_API
...
   该接口用于查询有人消息提醒计划。本文档仅适用于设备型号 CSEPMR511，其余型号不保证可用。
...
```
curl --location --request GET 'https://open.ys7.com/api/v3/otap/prop/{deviceSerial}/global/0/HumanDetection/MsgRemindPlan' \
