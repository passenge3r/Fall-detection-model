# API-设备云组件仓-A3网关-基础功能-资源列表

> 更新时间: 2026-07-06T17:45:39.000+08:00

> 文档ID: 876 | 来源树: OPEN_API
...
   分页获取账号下的资源列表及资源基本信息。本节为A3网关相关接口，网关核心功能是管理子设备，适用网关型号：CS-A3-W、CS-ATQ3-W。注：网关下子设备相关接口需用长序列号调用，例：C87654321-C12345678。

- 请求地址

`https://open.ys7.com/api/route/userdevicetob/v3/devices/resources`
...
| Body | Limit | Integer | 分页大小，默认是：8 | N |
| Body | Offset | Integer | 偏移量，默认是：0 | N |

- 请求示例

```
curl --location --request GET 'https://open.ys7.com/api/route/userdevicetob/v3/devices/resources' \
...
| data.resourceIdentifier | String | 资源描述标识 |
