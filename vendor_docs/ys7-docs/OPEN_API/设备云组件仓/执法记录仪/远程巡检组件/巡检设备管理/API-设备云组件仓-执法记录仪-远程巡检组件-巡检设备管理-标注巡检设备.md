# API-设备云组件仓-执法记录仪-远程巡检组件-巡检设备管理-标注巡检设备

> 更新时间: 2026-07-09T13:41:56.000+08:00

> 文档ID: 741 | 来源树: OPEN_API
...
   标注巡检设备，将巡检设备标注为执法记录仪设备，与工地进行关联
...
| Body | inspectDistrictCode | String | 巡检区域标识 | Y |

- 请求示例

```
curl --location --request POST 'https://open.ys7.com/api/service/devicekit/bodycamera' \
