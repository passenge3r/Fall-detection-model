# API-设备云组件仓-门禁-基础功能-添加人员扩展信息

> 更新时间: 2026-07-06T13:47:08.000+08:00

> 文档ID: 1102 | 来源树: OPEN_API
...
   该接口用于添加人员扩展信息，需提前[开通云录制服务](https://open.ys7.com/help/354)存储图片，支持人脸与卡权限录入。本文档仅适用于设备型号 DS-K1T系列的人脸门禁，其余型号不保证可用。

- 请求地址

`https://open.ys7.com/api/v3/device/company/member/ext/add`
...
| Body | base64FaceImageFile | String | BASE64编码图片数据:最大1.5M | N |
...
| Body | maxOpenDoorTime | String | 最大认证次数 默认0 取值范围[0,255] | N |
| Body | validEnable | String | 有效期使能标识:0-使能，1-不使能 默认1, 为0的时候beginTime和endTime不能为空 | N |
| Body | beginTime | String | 有效期起始日期时间格式:yyyy-MM-dd HH:mm:ss | Y |
| Body | endTime | String | 有效期结束日期时间格式:yyyy-MM-dd HH:mm:ss | Y |
...
```
curl --location --request POST 'https://open.ys7.com/api/v3/device/company/member/ext/add' \
--header 'accessToken: at.xxxxx' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--data-urlencode 'empId=77ef1a61776e4812b12dcb1d3a3eaa61' \
--data-urlencode 'faceImageUrl=http://xxxxx' \
--data-urlencode 'base64FaceImageFile=data:image/***;base64,body' \
