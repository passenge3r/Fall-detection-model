# API-设备云组件仓-客流统计相机-多维客流设备分页查询

>  

> 更新时间: 2026-06-30T11:48:28.000+08:00

> 文档ID: 1545 | 来源树: OPEN_API
...
`https://open.ys7.com/api/service/devicekit/peoplecounting/list`
...
| body | id | Int | 起始id最小值0 | Y |
| body | pageSize | Int | 查询数量，取值范围为(0-10] | N |

- 请求示例

```
curl --location --request POST 'https://open.ys7.com/api/service/devicekit/peoplecounting/list' \
--header 'accessToken: at.xxxxx' \
--header 'Content-Type: application/json' \
--data-raw '{"regionTag":"region01","id":0,"pageSize":10}'
```
