# API-设备云组件仓-客流统计相机-标记多维客流设备

>  

> 更新时间: 2026-06-30T11:48:26.000+08:00

> 文档ID: 1544 | 来源树: OPEN_API
...
`https://open.ys7.com/api/service/devicekit/peoplecounting/add`
...
```
curl --location --request POST 'https://open.ys7.com/api/service/devicekit/peoplecounting/add' \
--header 'accessToken: at.xxxxx' \
--header 'deviceSerial: G12345678' \
--header 'channelNo: 1' \
--header 'Content-Type: application/json' \
--data-raw '{"regionTag":"region01"}'
```
