# API-设备云组件仓-智能温控器-显示屏-查询屏幕待机时长

> 更新时间: 2026-07-06T13:49:09.000+08:00

> 文档ID: 1164 | 来源树: OPEN_API
...
   查询屏幕待机时长。本文档仅适用于设备型号 CS-HAE-PH3-NWG，其它型号不保证可用。
...
| data | Object | 业务参数 |
| data.time | Integer | 单位s，当 enabled 字段为 true 这个时间才有意义，取值范围[0,300] |
| data.enabled | Boolean | true 待机，false 一直亮着 |
