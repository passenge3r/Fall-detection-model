# API-设备云组件仓-智能温控器-空气调节-查询空调定时计划

> 更新时间: 2026-07-06T13:50:14.000+08:00

> 文档ID: 1193 | 来源树: OPEN_API
...
   查询空调定时计划。本文档仅适用于设备型号 CS-HAE-PH3-NWG，其它型号不保证可用。
...
```
curl --location --request GET 'https://open.ys7.com/api/v3/otap/prop/{deviceSerial}/global/0/AirConditionCtrl/ACTimePlan' \
...
| data.plan.repeatPeriod | Array | 重复周期（为空，执行一次），取值范围[0,16] |
| data.plan.action | Array | 计划操作内容，取值范围[0,8] |
