# API-云直播-用量查询-流量查询-查询指定设备在某一时间段消耗流量数据

> API-云直播-用量查询-流量查询-查询指定设备在某一时间段消耗流量数据

> 更新时间: 2026-06-30T17:55:00.000+08:00

> 文档ID: 1427 | 来源树: OPEN_API
...
   该接口用于查询指定设备在某一时间段消耗流量数据。子账户token无权限请求。
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/traffic/device/detail' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--data-urlencode 'accessToken=at.xxxxx' \
--data-urlencode 'deviceSerial=427734333' \
