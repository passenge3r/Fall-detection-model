# API-云直播-用量查询-流量查询-查询账户下某天流量消耗详情

> API-云直播-用量查询-流量查询-查询账户下某天流量消耗详情

> 更新时间: 2026-06-30T17:54:58.000+08:00

> 文档ID: 1426 | 来源树: OPEN_API
...
   该接口用于查询账户下某天流量消耗详情。子账户token无权限请求。
...
| body | flowTime | Long | 日期，时间格式为1457420564508，精确到毫秒，默认为当前日期往前1天。只能查询当前日期往前推算7天内、1天前的数据 | N |
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/traffic/day/detail' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--data-urlencode 'accessToken=at.xxxxx' \
--data-urlencode 'flowTime=1495209600000' \
