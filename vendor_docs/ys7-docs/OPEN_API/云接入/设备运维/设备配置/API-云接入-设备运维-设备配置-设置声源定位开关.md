# API-云接入-设备运维-设备配置-设置声源定位开关

> 更新时间: 2026-07-09T13:40:10.000+08:00

> 文档ID: 709 | 来源树: OPEN_API
...
   该接口用于设置设备声源定位开关状态（需要设备支持能力集：support\_ssl）

- 请求地址

`https://open.ys7.com/api/lapp/device/ssl/switch/set`
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/device/ssl/switch/set' \
