# API-云接入-设备运维-设备配置-获取全天录像开关状态

> 更新时间: 2026-07-09T13:40:16.000+08:00

> 文档ID: 712 | 来源树: OPEN_API
...
   该接口用于获取设备全天录像开关状态（需要设备支持全天录像功能） 子账户token请求所需最小权限："Permission":"Get" "Resource":"Cam:序列号:通道号"
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/device/fullday/record/switch/status' \
