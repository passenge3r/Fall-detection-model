# API-云接入-设备运维-设备配置-设置wifi配置提示音开关

> 更新时间: 2026-07-09T13:40:01.000+08:00

> 文档ID: 705 | 来源树: OPEN_API
...
   该接口用于设置wifi配置或设备启动提示音开关 子账户token请求所需最小权限："Permission":"Config" "Resource":"Cam:序列号:通道号"

- 请求地址

`https://open.ys7.com/api/lapp/device/sound/switch/set`
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/device/sound/switch/set' \
