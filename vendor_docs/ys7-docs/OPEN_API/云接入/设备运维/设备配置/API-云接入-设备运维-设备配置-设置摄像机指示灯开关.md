# API-云接入-设备运维-设备配置-设置摄像机指示灯开关

> 更新时间: 2026-07-09T13:40:14.000+08:00

> 文档ID: 711 | 来源树: OPEN_API
...
   该接口用于设置摄像机指示灯开关状态（需要设备支持指示灯功能） 子账户token请求所需最小权限："Permission":"Config" "Resource":"Cam:序列号:通道号"

- 请求地址

`https://open.ys7.com/api/lapp/device/light/switch/set`
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/device/light/switch/set' \
