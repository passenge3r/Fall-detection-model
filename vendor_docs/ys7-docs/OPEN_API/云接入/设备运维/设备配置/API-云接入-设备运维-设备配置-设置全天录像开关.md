# API-云接入-设备运维-设备配置-设置全天录像开关

> 更新时间: 2026-07-09T13:40:18.000+08:00

> 文档ID: 713 | 来源树: OPEN_API
...
   该接口用于设置全天录像开关状态（需要设备支持全天录像功能） 子账户token请求所需最小权限："Permission":"Config" "Resource":"Cam:序列号:通道号"
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/device/fullday/record/switch/set' \
