...
> 更新时间: 2026-05-25T16:38:13.000+08:00

> 文档ID: 5064 | 来源树: OPEN_API
...
| localIndex | string | Y | 通道号 |  |

### body

| 名称 | 类型 | 必填 | 描述 | 示例指及参考API |
| --- | --- | --- | --- | --- |
| enable | boolean | Y | false-关，true-开 |  |

### 请求示例

```
curl --location --request POST 'https://open.ys7.com/api/v3/device/ptz/cruise/auto/switch?enable=false' \
