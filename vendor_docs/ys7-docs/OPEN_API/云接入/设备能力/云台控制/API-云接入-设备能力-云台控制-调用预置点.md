# API-云接入-设备能力-云台控制-调用预置点

> 更新时间: 2026-07-09T13:33:57.000+08:00

> 文档ID: 683 | 来源树: OPEN_API
...
   对预置点进行调用控制 子账户token请求所需最小权限："Permission":"Ptz" "Resource":"Cam:序列号:通道号"
...
| Body | index | Int | 预置点，C6设备预置点是1-12 | Y |

- 请求示例

```
curl --location --request POST 'https://open.ys7.com/api/lapp/device/preset/move' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--data-urlencode 'accessToken=at.xxxxx' \
--data-urlencode 'deviceSerial=xxxxx' \
--data-urlencode 'channelNo=1' \
--data-urlencode 'index=3'
```
