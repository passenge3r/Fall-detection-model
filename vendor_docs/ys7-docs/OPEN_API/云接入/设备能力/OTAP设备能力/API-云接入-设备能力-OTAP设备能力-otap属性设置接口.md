# API-云接入-设备能力-OTAP设备能力-otap属性设置接口

>  

> 更新时间: 2026-06-30T10:58:18.000+08:00

> 文档ID: 1513 | 来源树: OPEN_API
...
| body | Body | String | JSON结构，格式参见属性报备时的示例报文 | Y |
...
--data-raw '{"timeZone":"CST-08:00:00"}'
```
...
```
{
    "meta": {
        ...
        "moreInfo": {
            "msgDetail": "param error : 设备不支持该功能"
        }
    }
}
```
