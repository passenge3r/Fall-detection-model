# API-云接入-设备能力-客流统计-设置客流统计开关

> 更新时间: 2026-07-09T13:39:43.000+08:00

> 文档ID: 689 | 来源树: OPEN_API
...
   该接口用于设置客流统计开关（接口需要设备支持客流统计功能） 子账户token请求所需最小权限："Permission":"Config" "Resource":"dev:序列号"
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/passengerflow/switch/set' \
