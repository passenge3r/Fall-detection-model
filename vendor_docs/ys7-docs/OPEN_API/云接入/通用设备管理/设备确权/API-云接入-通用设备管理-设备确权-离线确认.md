# API-云接入-通用设备管理-设备确权-离线确认

> 更新时间: 2026-07-09T18:39:15.000+08:00

> 文档ID: 665 | 来源树: OPEN_API
...
```
curl --location --request GET 'https://open.ys7.com/api/userdevice/v3/devices/realtimestatus?accessToken=xxxxx&deviceSerial=xxxxx'
```
