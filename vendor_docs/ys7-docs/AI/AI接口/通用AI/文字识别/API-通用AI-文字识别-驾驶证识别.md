...
> 更新时间: 2026-07-01T18:43:28.000+08:00
...
   该接口用于提供对一张驾驶证的识别能力，分析驾驶证的相关数据。子账户token请求所需最小权限：无。
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/intelligence/ocr/driverLicense' \
