...
> 更新时间: 2026-07-01T18:44:08.000+08:00
...
   该接口用于将检测的人脸注册到创建的人脸集合。子账户token请求所需最小权限：无。
...
| Body | setToken | String | 人脸集合的唯一标识 | Y |

- 请求示例

```
curl --location --request POST 'https://open.ys7.com/api/lapp/intelligence/face/set/register' \
