...
> 更新时间: 2026-07-01T18:44:14.000+08:00
...
   该接口用于将已注册的人脸从人脸集合中移除。子账户token请求所需最小权限：无。
...
```
curl --location --request POST 'https://open.ys7.com/api/lapp/intelligence/face/set/remove' \
